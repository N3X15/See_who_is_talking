...
namespace See_who_is_talking
{
	...
	public class See_who_is_talking : BaseUnityPlugin
	{
		...
		internal static ManualLogSource Logger
		{
			get
			{
				return See_who_is_talking.Instance._logger;
			}
		}
		...
		private void Awake()
		{
			See_who_is_talking.Instance = this;
			base.gameObject.transform.parent = null;
			base.gameObject.hideFlags = HideFlags.HideAndDontSave;
			if (UnityEngine.Object.FindObjectOfType<VoiceDisplayManager>() == null)
			{
				GameObject go = new GameObject("VoiceDisplay");
				UnityEngine.Object.DontDestroyOnLoad(go);
				go.hideFlags = HideFlags.HideAndDontSave;
				go.AddComponent<VoiceDisplayManager>();
			}
			this.Patch();
			See_who_is_talking.Logger.LogInfo(string.Format("{0} v{1} has loaded!", base.Info.Metadata.GUID, base.Info.Metadata.Version));
		}
		...
		internal void Patch()
		{
			...
			{
				this.Harmony = new Harmony(base.Info.Metadata.GUID);
			}
